...
export interface CombineToolOverride {
  ...
  finger_hole_shape: "circular" | "rounded_rect" | null;
  finger_hole_length_mm: number | null;
  finger_hole_width_mm: number | null;
  finger_hole_corner_radius_mm: number | null;
...
export interface CombineTool extends Placement {
  ...
  finger_hole_shape: "circular" | "rounded_rect";
  finger_hole_shape_inherited: "circular" | "rounded_rect";
  finger_hole_shape_override: "circular" | "rounded_rect" | null;
  finger_hole_length_mm: number;
  finger_hole_length_mm_inherited: number;
  finger_hole_length_mm_override: number | null;
  finger_hole_width_mm: number;
  finger_hole_width_mm_inherited: number;
  finger_hole_width_mm_override: number | null;
  finger_hole_corner_radius_mm: number;
  finger_hole_corner_radius_mm_inherited: number;
  finger_hole_corner_radius_mm_override: number | null;
