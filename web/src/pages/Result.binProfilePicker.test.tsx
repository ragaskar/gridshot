...
function fakeResult(): TraceResult {
  return {
    ...
    bin: {
      ...
      lip: true, magnet_holes: false, magnet_hole_diameter_mm: 6.5, magnet_hole_depth_mm: 2, magnet_corners_only: false, magnet_easy_release: "off",
...
describe("Result page bin profile picker", () => {
  beforeEach(() => {
    ...
    useApp.setState({
      ...
      params: { clearance: 1, fill_height_pct: 100, live_grid: false, finger_hole: true, lip: true } as never,
    });
  });
  ...
  it("applies a profile's fill height, lip, and magnet-hole defaults to the regenerate form", async () => {
    render(<Result />);
