...
def _fork(source: LibraryTool, new_id: str, *, label: str) -> LibraryTool:
    ...
    forked = LibraryTool(
        ...
        finger_hole_radial_offset_mm=source.finger_hole_radial_offset_mm,
        finger_hole_shape=source.finger_hole_shape,
        finger_hole_length_mm=source.finger_hole_length_mm,
        finger_hole_width_mm=source.finger_hole_width_mm,
        finger_hole_corner_radius_mm=source.finger_hole_corner_radius_mm,
        lip=source.lip,
